  ...
  return (
    <div className="min-h-screen flex flex-col bg-health-light">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-health-primary/10 to-health-secondary/5">
          <div className="container mx-auto max-w-7xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                <div className="space-y-4">
                  <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-health-dark">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link to="/symptom-checker">
                    <Button className="text-lg px-6 py-6 bg-health-primary hover:bg-health-primary/90">
                      Check Your Symptoms
                    </Button>
                  </Link>
          ...
          <div className="container mx-auto max-w-7xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="border-0 shadow-lg">
                <CardHeader>
                  <div className="w-12 h-12 rounded-full bg-health-primary/20 flex items-center justify-center mb-4">
                    <span className="text-health-primary text-xl font-bold">1</span>
                  </div>
              ...
              <Card className="border-0 shadow-lg">
                <CardHeader>
                  ...
                  <CardTitle>Get AI Analysis</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
              ...
              <Card className="border-0 shadow-lg">
                <CardHeader>
                  ...
                  <CardTitle>Receive Health Advice</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-health-dark">Features</h2>
              <p className="mt-4 text-xl text-gray-600">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="p-6 border rounded-lg">
                <div className="w-12 h-12 rounded-full bg-health-primary/10 flex items-center justify-center mb-4">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 text-health-primary">
              ...
              <div className="p-6 border rounded-lg">
                ...
                <h3 className="text-xl font-bold mb-2">Pill Identification</h3>
                <p className="text-gray-600">
              ...
              <div className="p-6 border rounded-lg">
                ...
                <h3 className="text-xl font-bold mb-2">Health Advice</h3>
                <p className="text-gray-600">
              ...
              <div className="p-6 border rounded-lg">
                ...
                <h3 className="text-xl font-bold mb-2">Severity Assessment</h3>
                <p className="text-gray-600">
              ...
              <div className="p-6 border rounded-lg">
                ...
                <h3 className="text-xl font-bold mb-2">Symptom History</h3>
                <p className="text-gray-600">
        ...
        {/* CTA Section */}
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-health-primary text-white">
          <div className="container mx-auto max-w-5xl text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/symptom-checker">
                <Button size="lg" className="bg-white text-health-primary hover:bg-gray-100 hover:text-health-primary border-white">
                  Check Symptoms Now
                </Button>
              </Link>
              {!isAuthenticated && (
      ...
      <footer className="bg-gray-100 py-8 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="text-health-primary flex items-center gap-1 mb-4">
                <svg 
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/symptom-checker" className="text-gray-600 hover:text-health-primary text-sm">Symptom Checker</Link></li>
                <li><Link to="/pill-analyzer" className="text-gray-600 hover:text-health-primary text-sm">Pill Analyzer</Link></li>
                <li><Link to="/history" className="text-gray-600 hover:text-health-primary text-sm">My History</Link></li>
              </ul>
            </div>
